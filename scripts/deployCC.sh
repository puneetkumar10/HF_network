...
## Install chaincode on peer0.orgTourist and peer0.orgToursChateau
echo "Installing chaincode on peer0.orgTourist..."
installChaincode 1
echo "Install chaincode on peer0.orgToursChateau..."
installChaincode 2

## query whether the chaincode is installed
queryInstalled 1

## approve the definition for orgTourist
approveForMyOrg 1

## check whether the chaincode definition is ready to be committed
## expect orgTourist to have approved and orgToursChateau not to
checkCommitReadiness 1 "\"OrgTouristMSP\": true" "\"OrgToursChateauMSP\": false"
checkCommitReadiness 2 "\"OrgTouristMSP\": true" "\"OrgToursChateauMSP\": false"

## now approve also for orgToursChateau
approveForMyOrg 2

## check whether the chaincode definition is ready to be committed
## expect them both to have approved
checkCommitReadiness 1 "\"OrgTouristMSP\": true" "\"OrgToursChateauMSP\": true"
checkCommitReadiness 2 "\"OrgTouristMSP\": true" "\"OrgToursChateauMSP\": true"
...
# Query chaincode on peer0.orgTourist
echo "Querying chaincode on peer0.orgTourist..."
chaincodeQuery 1
