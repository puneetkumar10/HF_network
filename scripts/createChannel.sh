...
createAncorPeerTx() {
	...
	for orgmsp in OrgTouristMSP OrgToursChateauMSP; do
...
echo "Join OrgTourist peers to the channel..."
joinChannel 1
echo "Join OrgToursChateau peers to the channel..."
joinChannel 2

## Set the anchor peers for each org in the channel
echo "Updating anchor peers for orgTourist..."
updateAnchorPeers 1
echo "Updating anchor peers for orgToursChateau..."
updateAnchorPeers 2
